...
@interface NSArray (SWIFT_EXTENSION(Flink_It))
@end


@interface NSData (SWIFT_EXTENSION(Flink_It))
@end


@interface NSDictionary (SWIFT_EXTENSION(Flink_It))
@end
...
@interface NSNull (SWIFT_EXTENSION(Flink_It))
@end


@interface NSString (SWIFT_EXTENSION(Flink_It))
@end


SWIFT_CLASS("_TtC8Flink_It7SSLCert")
...
SWIFT_CLASS("_TtC8Flink_It11SSLSecurity")
...
SWIFT_CLASS("_TtC8Flink_It16SocketAckEmitter")
...
SWIFT_CLASS("_TtC8Flink_It14SocketAnyEvent")
...
/**
  ...
  \endcode*/
SWIFT_CLASS("_TtC8Flink_It19SocketClientManager")
...
SWIFT_PROTOCOL("_TtP8Flink_It16SocketEngineSpec_")
...
SWIFT_CLASS("_TtC8Flink_It12SocketEngine")
...
SWIFT_CLASS("_TtC8Flink_It14SocketIOClient")
...
SWIFT_CLASS("_TtC8Flink_It9WebSocket")
