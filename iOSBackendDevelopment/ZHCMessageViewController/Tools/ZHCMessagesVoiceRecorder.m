...
- (void)zhc_startRecording {
    ...
    if (! audioHWAvailable) {
        [[AlertView sharedManager] displayInformativeAlertwithTitle:@"Warning" andMessage:@"Audio input hardware not available" onController:[APPDELEGATE navController]];
...
//        [cantRecordAlert show];
    ...
    if(!AudioRecorder){
        ...
        [[AlertView sharedManager] displayInformativeAlertwithTitle:@"Warning" andMessage:[err localizedDescription] onController:[APPDELEGATE navController]];
//        UIAlertView *alert =
//        [[UIAlertView alloc] initWithTitle: @"Warning"
