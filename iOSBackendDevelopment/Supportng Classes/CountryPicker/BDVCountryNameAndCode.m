...
@implementation BDVCountryNameAndCode{
    ...
    NSMutableDictionary *dictDialingCodes,*countryWithDialCode,*countryCodeForDialCode,*countryCodeForCountryName;
...
-(id)init{
    ...
    */
        ...
        countryWithDialCode = [[NSMutableDictionary alloc] init];
        countryCodeForDialCode = [[NSMutableDictionary alloc] init];
        countryCodeForCountryName = [NSMutableDictionary new];
        for (NSDictionary* obj in BDVCountryNameAndCodePlist) {
            ...
            [countryWithDialCode setObject:[obj objectForKey:@"name"] forKey:[obj objectForKey:@"dial_code"]];
            [countryCodeForDialCode setObject:[obj objectForKey:@"code"] forKey:[obj objectForKey:@"dial_code"]];
            [countryCodeForCountryName setObject:[obj objectForKey:@"code"] forKey:[obj objectForKey:@"name"]];
...
-(NSString *)prefixForCurrentLocale {
    ...
    NSString *countryLocale = [[[NSLocale currentLocale] objectForKey:NSLocaleCountryCode] uppercaseString];
...
-(NSString *)countryNameForCurrentLocale {
    ...
    NSInteger indexOfPrefixAtCountryNamesArray = [prefixDialingCodes indexOfObject: [self prefixForCurrentLocale]];
...
-(UIImage *)countryFlagForCurrentLocale {
    ...
    NSString *imageName = [NSString stringWithFormat:@"CountryPicker.bundle/%@",[[NSLocale currentLocale] objectForKey:NSLocaleCountryCode]];
...
-(NSString *)getCountryNameForDialCode:(NSString *)prefix{
    return [countryWithDialCode valueForKey:prefix];
}
-(NSString *)getCountryCodeForDialCode:(NSString *)prefix{
    return [countryCodeForDialCode valueForKey:prefix];
}
-(NSArray *)getCountrySuffixForCountryName:(NSString *)prefix{
    return [countryCodeForCountryName valueForKey:prefix];
}
